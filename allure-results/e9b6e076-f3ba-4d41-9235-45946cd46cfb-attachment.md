...
- banner:
  ...
  - list:
    ...
    - listitem:
      - link " Contact us":
        - /url: /contact_us
    - listitem:  Logged in as nhathuynh
- list:
  - listitem
  - listitem
  - listitem
...
- paragraph:
  ...
  - link "Automated development tools":
    - img
    - text: Automated development tools
- link "Test Cases":
  - /url: /test_cases
  - button "Test Cases"
...
- insertion:
  - iframe
- img
- link "Go to shopping options for Kids' Frozen Tops": Kids' Frozen Tops
