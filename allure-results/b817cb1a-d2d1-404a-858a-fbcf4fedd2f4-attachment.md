...
- text: Mrs. Name
- superscript: "*"
- textbox "Name *": nhathuynh
- text: Email
- superscript: "*"
- textbox "Email *" [disabled]: nhathuynh34@gmail.com
- text: Password
- superscript: "*"
- textbox "Password *": GoMobile!123
- text: Date of Birth
- combobox:
  - option "Day"
  - option "1"
...
- paragraph:
  - text: First name
  - superscript: "*"
  - textbox "First name *": Nhat
- paragraph:
  - text: Last name
  - superscript: "*"
  - textbox "Last name *": Huynh
- paragraph:
  - text: Company
  - textbox "Company": KMS
- paragraph:
  ...
  - textbox "Address * (Street address, P.O. Box, Company name, etc.)": 221 TQK
- paragraph:
  - text: Address 2
  - textbox "Address 2": Q1
- paragraph:
  - text: Country
  - superscript: "*"
  - combobox "Country *":
...
- paragraph:
  - text: Mobile Number
  - superscript: "*"
  - textbox "Mobile Number *": "0916854821"
